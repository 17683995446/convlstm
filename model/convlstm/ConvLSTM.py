...
class ConvLSTMCell(nn.Module):
    ...
    def forward(self, input_tensor, cur_state):
        ...
        # print("",h_cur.cpu().data.numpy().shape)
    ...
    def init_hidden(self, batch_size, image_size):
        height, width,z = image_size
        h = torch.zeros(batch_size, self.hidden_dim, height, width,z, device=self.conv.weight.device)
        c = torch.zeros(batch_size, self.hidden_dim, height, width,z, device=self.conv.weight.device)
        return h, c
